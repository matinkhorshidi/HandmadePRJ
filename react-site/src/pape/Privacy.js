...
const Privacy = (props) => {
    ...
    return (
        <div className={"mt-5 mx-5 "}>
            ...
            Handmade Interactive LLC built the History Run! app as a Free app. This SERVICE is
            provided by Handmade Interactive LLC at no cost and is intended for use as is.
            ...
            Conditions, which are accessible at History Run! unless otherwise defined in this Privacy
            Policy.
                <h4 className='fw-bold mt-3'>    Information Collection and Use</h4>

            For a better experience, while using our Service, we may require you to provide us with
            certain personally identifiable information, including but not limited to Retention, Player
            Behavior, Analectic data. The information that we request will be retained by us and
            ...
            Link to the privacy policy of third-party service providers used by the app
                ...
                <h4 className='fw-bold mt-3'>  Log Data</h4>
            ...
            statistics.
                <h4 className='fw-bold mt-3'> Cookies</h4>
            ...
            able to use some portions of this Service.
                <h4 className='fw-bold mt-3'> Service Providers</h4>
            ...
            purpose.
                <h4 className='fw-bold mt-3'>Security</h4>
            ...
            reliable, and we cannot guarantee its absolute security.
                <h4 className='fw-bold mt-3'>Links to Other Sites</h4>
            ...
            third-party sites or services.
                <h4 className='fw-bold mt-3'>   Children’s Privacy</h4>
            ...
            contact us at info@thehandmade.io
        </div>
    );
};
